const CACHE='connection-health-v1';
const ASSETS=['/','/assets/css/site.css','/assets/js/app.js','/assets/js/config.js','/assets/js/ads.js','/assets/js/pwa.js','/manifest.webmanifest','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
