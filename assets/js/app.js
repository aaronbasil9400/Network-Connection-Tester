...
function updateProgress(p,text){const x=clamp(p,0,100);els.runProgress.style.clipPath=`inset(0 ${100-x}% 0 0)`;els.runProgressDot.style.left=`${x}%`;els.progressText.textContent=text}
